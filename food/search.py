...
__all__ = ['cos', 'multiply_vector', 'drop_vector', 'foods', 'foods', 'read_image_from_url', 'search_image_',
           ...
           'search_image_', 'series2tensor', 'multiply_vector', 'drop_vector', 'multiple_foods', 'search_image', 'cos',
           'q', 'foods', 'read_image_from_url', 'search_image_', 'series2tensor', 'multiply_vector', 'drop_vector',
           'multiple_foods', 'search_image']
