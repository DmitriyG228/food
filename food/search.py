...
__all__ = ['cos', 'q', 'foods', 'read_image_from_url', 'search_image_', 'series2tensor', 'multiply_vector',
           'drop_vector', 'multiple_foods', 'search_image', 'cos', 'q', 'foods', 'read_image_from_url', 'search_image_',
           'series2tensor', 'multiply_vector', 'drop_vector', 'multiple_foods', 'search_image']
...
# Cell
q = """select  i.food_id,f.description, f.category,f.energy,f.protein,f.carb,f.fat,i.id
