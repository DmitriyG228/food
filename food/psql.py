...
__all__ = ['engine', 'Session', 'session', 'Base', 'du', 'query', 'current', 'kill', 'insert_ignore', 'Foods',
           'Portions', 'Foods_weighted', 'Indexed', 'Dishes', 'Dishes']
...
# Cell
class Foods_weighted (Base):
    __tablename__ = 'foods_weighted'
    index               = Column(BIGINT,         primary_key=True,autoincrement=True)
    id                  = Column(BIGINT,          primary_key=True)
    description         = Column(String,          nullable=False)
