...
__all__ = ['engine', 'Session', 'session', 'Base', 'du', 'query', 'current', 'kill', 'insert_ignore', 'schema',
           'LocalBase', 'Foods', 'Users', 'Dishes', 'User_properties', 'Logs', 'FoodsP', 'FoodsPI', 'read_sql']
...
# Cell
engine = create_engine('postgresql+psycopg2://postgres:KJnbuiwuef89k@localhost/postgres?port=5435',pool_size=64) #new
