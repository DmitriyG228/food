...
__all__ = ['engine', 'Session', 'session', 'Base', 'du', 'query', 'current', 'kill', 'insert_ignore', 'schema',
           'LocalBase', 'Foods', 'FoodsP', 'FoodsPI', 'read_sql', 'Users_metrics', 'Dishes_test', 'Users_test']
...
# Cell
engine = create_engine('postgresql+psycopg2://postgres:KJnbuiwuef89k@localhost/postgres?port=5434',pool_size=64) #new
