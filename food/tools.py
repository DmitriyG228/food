...
__all__ = ['kill', 'get_hash_folder', 'save_selected_cities', 'save_location_dicts', 'get_top_n_countries', 'path_info',
           'rm_r', 'search_notebooks', 'df_chunk_generator', 'docker_container', 'LogDBHandler', 'get_logger',
           ...
           'sql_head', 'make_clickable', 'selected_countries']
